...
def downloadsocks(choice):
    ...
    if choice == "5":
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://ghproxy.com/https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/socks5.txt", timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get(
                "https://ghproxy.com/https://raw.githubusercontent.com/TryAgainC/myproxy/main/socks5.txt",
                timeout=5)
            f.write(r.content)
        except:
            pass
        ...
        try:
            r = requests.get(
                "https://ghproxy.com/https://gist.githubusercontent.com/Azuures/1e0cb7a1097c720b4ed2aa63acd82179/raw/97d2d6a11873ffa8ca763763f7a5dd4035bcf95f/fwefnwex",
                timeout=5)
            f.write(r.content)
            f.close()
        except:
    ...
    if choice == "1":
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://ghproxy.com/https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/http.txt", timeout=5)
            f.write(r.content)
           
        except:
            pass
        try:
            r = requests.get("https://ghproxy.com/https://raw.githubusercontent.com/TryAgainC/myproxy/main/http.txt", timeout=5)
            f.write(r.content)
